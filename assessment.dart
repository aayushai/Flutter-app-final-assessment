      ...
      child: Scaffold(
        ...
        Column(
          children: [
            ...
            Text(" TRAINING",style: TextStyle(fontSize: 20,color: Colors.amberAccent,decoration: TextDecoration.none,fontWeight: FontWeight.bold),),
            Padding(padding: EdgeInsets.only(top: 40,bottom: 30)),
            Image(image: AssetImage("assets/R.jpg")),
            Padding(padding: EdgeInsets.only(top: 40,bottom: 30)),
            SizedBox(child: ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) {
              return User_login();}));}, child: Text("Get Started"),style: ElevatedButton.styleFrom(primary: Colors.amberAccent),),
              width: 300,),
          ],
        ...
        body: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("Login",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.amberAccent),),
            ),
            TextField(
            ...
            SizedBox(child: ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) {
              return Training_completion();}));}, child: Text("Login"),style: ElevatedButton.styleFrom(primary: Colors.amberAccent),),
              width: 300,),
      ...
      SafeArea(
        child: Column
          ...
          children: [
            ...
            Image(image: AssetImage("assets/OIP.jpg")),
